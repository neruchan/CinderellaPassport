...
$adminEmail = "nelson@starty-in.jp";

$fromDisplay = "スターFP事務所1";

$subjectForAdmin = "ご相談フォーム「スターFP事務所」より2";

$subjectForCust = '[ご相談フォーム]送信内容控え｜スターFP事務所3';

$custHeader = '
4【このメールはご相談フォームから自動返信されています。】

ご連絡頂きまして誠にありがとうございました。
下記内容にて受け付けました。
ご住所等の確認のためお電話をさせて頂く場合もございますが
...
$custFooter = '5
────────────────────────────────────
保険相談、保険見直しは『スターFP事務所』
お電話のお問い合わせ
フリーダイヤル：0120-3704-25
FAX:0166-74-6040
────────────────────────────────────
';
